<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <textarea id="self_introduction" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" name="self_introduction" rows="5" required autofocus autocomplete="self_introduction">{{ old('self_introduction') }}</textarea>
